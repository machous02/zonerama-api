...
#     slide_div = soup.find(class_="swiper-slide active li-edit")
#     assert slide_div is not None
#     assert isinstance(slide_div, Tag)

#     data_page = slide_div["data-page"]
#     assert isinstance(data_page, str)

#     return data_page == folder_id

#     # url_tag = soup.find("meta", property="og:url")
#     # assert url_tag is not None
#     # assert isinstance(url_tag, Tag)
